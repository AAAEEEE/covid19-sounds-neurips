...
def define_audio_slim(modality=params.MODALITY,reg_l2=params.L2, rnn_units=32, 
                        num_units=params.NUM_UNITS, modfuse = params.MODFUSE, train_vgg = False):
    ...
    with slim.arg_scope([slim.fully_connected],
                        weights_initializer=tf.truncated_normal_initializer(
                          stddev=params.INIT_STDDEV, seed=0), #1 is the best for old data
